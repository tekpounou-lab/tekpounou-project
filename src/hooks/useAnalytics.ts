...
export function useAnalytics() {
  ...
  const logCourseView = useCallback(
  ...
  const logLessonStart = useCallback(
  ...
  const logLessonComplete = useCallback(
    (
      lessonId: string,
      lessonTitle: string,
      timeSpent: number,
  ...
  const logEnrollment = useCallback(
    (courseId: string, courseTitle: string) => {
      logEvent({
  ...
  const logServiceRequest = useCallback(
    (serviceId: string, serviceName: string, requestId?: string) => {
      logEvent({
  ...
  const logProjectView = useCallback(
  ...
  const logTaskUpdate = useCallback(
    (
      taskId: string,
      taskTitle: string,
      oldStatus: string,
  ...
  const logQuizAttempt = useCallback(
    (quizId: string, quizTitle: string, score: number, lessonId?: string) => {
      logEvent({
